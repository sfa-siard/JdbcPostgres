...
public class PostgresDatabaseMetaDataTester extends BaseDatabaseMetaDataTester {
    ...
    {
        try {
            _pqiNativeSimpleTable = new PostgresQualifiedId(TestPostgresDatabase.getQualifiedSimpleTable()
                                                                                .format());
            _pqiNativeComplexTable = new PostgresQualifiedId(TestPostgresDatabase.getQualifiedComplexTable()
                                                                                 .format());
            _pqiSqlSimpleTable = new PostgresQualifiedId(TestSqlDatabase.getQualifiedSimpleTable()
                                                                        .format());
            _pqiSqlComplexTable = new PostgresQualifiedId(TestSqlDatabase.getQualifiedComplexTable()
                                                                         .format());
            _pqiSqlSimpleView = new PostgresQualifiedId(TestSqlDatabase.getQualifiedSimpleView()
                                                                       .format());
    ...
    public void setUp() {
        try {
            ...
            dsPostgres.setUrl(postgres.getJdbcUrl());
            dsPostgres.setUser(postgres.getUsername());
            dsPostgres.setPassword(postgres.getUsername());
            PostgresConnection connPostgres = (PostgresConnection) dsPostgres.getConnection();
    ...
    public void testGetClientInfoProperties() {
        enter();
        try {
            print(getDatabaseMetaData().getClientInfoProperties());
        } catch (SQLException se) {
    ...
    public void testGetTableTypes() {
        enter();
        try {
            print(getDatabaseMetaData().getTableTypes());
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
    }
    ...
    private int sizeFromMax(long lMaxSigned) {
        int iSize = String.valueOf(lMaxSigned)
                          .length();
        return iSize;
    }
    ...
    public void testGetColumns() {
        try {
            PostgresQualifiedId pqiTable = new PostgresQualifiedId(TestPostgresDatabase.getQualifiedComplexTable()
                                                                                       .format());
                    ...
                    if (pqiTableView.equals(_pqiNativeSimpleTable) ||
                        ...
                        if (sColumnName.equalsIgnoreCase("CINT_DOMAIN") || sColumnName.equalsIgnoreCase("CYEAR")) {
                            ...
                            if (!sTypeName.startsWith(PostgresType.INTERVAL.getKeyword())) {
                                ...
                                sTypeName = pgtFound.getPreType()
                                                    .getKeyword();
                            }
                            iPrecision = parsePrecision(cd.getType());
                            iScale = parseScale(cd.getType());
                            if (!cd.getType()
                                   .startsWith(PostgresType.INTERVAL.getKeyword())) {
                                PostgresType pgtExpected = parsePostgresType(cd.getType());
                                iType = pgtExpected.getPreType()
                                                   .getSqlType();
                                sType = pgtExpected.getPreType()
                                                   .getKeyword();
    ...
    public void testGetAttributesComposite() {
        ...
        try {
            ...
            print(getDatabaseMetaData().getAttributes(null, qiType.getSchema()
                                                                  .toLowerCase(), qiType.getName()
                                                                                        .toLowerCase(), null));
        } catch (SQLException se) {
            fail(EU.getExceptionMessage(se));
        }
